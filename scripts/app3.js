...
//-------------------------------------
    ...
    // Funciones para tiempo y fechas
        ...
        function crearFecha(){
            ...
            // Variables para Fecha Formato 00/00/0000
    ...
    //----------------------------------------------------------------------------------
    // FUNCIÓN: crear el Código de la Factura 
    //----------------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------------------------
    // FUNCIÓN: convertir minutos a horas
    //-------------------------------------------------------------------------------------------
...
//
    ...
    function comprobarErrores(){
        ...
        //< Funciones para las Fechas >
            ...
            // Crear fecha funcion (formato Año-Mes-Dia (2024-04-16))
            function crearFecha(){
                ...
                let fechaSiguiente = sumaRestaFecha(fecha, "sumar", 1);
                let fechaAnterior = sumaRestaFecha(fecha, "restar", 1);

                return [fechaAnterior[0], fecha, fechaSiguiente[0], dia, mes, anio];
    ...
    // Eventos
        ...
        btnSig.addEventListener("click", ()=>{
            ...
            if(sumaErroresBtn == 0 && btnSiguienteDispon == 0){
                ...
                // Consulta Fetch
                let url = "http://localhost/BizLab/confirTarjetaCredito.php";
                    ...
                    if(data[2]["status"] == false){
                        ...
                        if(data[2]["status"] == true){
                            ...
                            function creaFechaCodFac(){
                                ...
                                return [fechaCreacion, horaCreacion, serieFactura, codFactura, codMembre];
                            ...
                            function registrarFacturaMembresia(
                                ...
                                let urlCreaFacMembre = "http://localhost/BizLab/registrarFacMembre.php";
                            ...
                            function userNewToken(data){

                                tokenUserNewG = data;

                                let membreCod = document.querySelector(".membreCodigo").value;

                                let urlGuardaTokenUser = "http://localhost/BizLab/guardarMiembroEpayco.php";
                                ...
                                fetch(urlGuardaTokenUser, {
                                    ...
                                    .then((data) => {
                                        ...
                                        console.log("IMPRESION FUERA 3: "+data);

                                    })
                                    .catch((err) => console.log(err));

                                tokenUsuarioDefini = tokenUserNewG;
                                console.log("IMPRESION FUERA 2: "+tokenUsuarioDefini);
                                //---------------------------------------------------------------------------------

                                //
                            
                                // Creando la subscripcion y pagando la primera mensualidad
                                let urlCrearSub = "http://localhost/BizLab/crearSubNueva.php";
                                ...
                                fetch(urlCrearSub, {
                                    ...
                                    .then((datas) => {
                                        ...
                                        console.log("SUB CREADA Y PAGADA: ");
                                        console.log(datas);
                            ...
                            btnUnirseA.addEventListener("click", (e)=>{
                                ...
                                if(
                                    ...
                                    if(tokenUser == ""){
                                        ...
                                        let urlCrearUserToken = "http://localhost/BizLab/crearUserToken.php";
                                        ...
                                        fetch(urlCrearUserToken, {
                                            ...
                                            .then((datas) => {
                                                ...
                                                console.log("IMPRESION DENTRO 1: "+datas);
                                                userNewToken(datas);
                                        ...
                                        tokenUsuarioDefini = tokenUser;

                                        console("VUELTA 2: "+tokenUsuarioDefini);
