...
<div class="header_div1">
                <div class="divPerfilContaint">
                    ...
                    <div class="divNombreCont">
                        <span class="nombrePerfil"><?php echo htmlspecialchars($userName); ?></span>
        ...
        <div class="contenedor_base_usuario">
          <div class="base1">
            <div class="informacion_usuario">
              <h3>Detalle de la informacion del usuario</h3>
            </div>
            <div class="contenedor_texto">
              <div class="texto_base">
                <p class="texto">Nombres:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_nombre']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Genero:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_genero']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Telefono:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_celular']); ?></h3>
              </div>
              <div class="texto_base"> 
                <p class="texto">Membresia:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['membre_nombre']); ?></h3> 
              </div>
            </div>
            <div class="contenedor_texto">
              <div class="texto_base">
                <p class="texto">Apellidos:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_apellido']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Rol:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_rol']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Ciudad:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_ciudad']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Correo:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_correo']); ?></h3>
              </div>
            </div>
            <div class="contenedor_texto">
              <div class="texto_base">
                <p class="texto">Cedula:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_documento']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Direccion:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_direc']); ?></h3>
              </div>
              <div class="texto_base">
                <p class="texto">Fecha de nacimiento:</p>
                <h3 class="texto"><?php echo htmlspecialchars($user['user_fNacimiento']); ?></h3> 
              </div>
            </div>
          </div>
          <div class="base_2">
            <div class="base3">
              ...
              <div class="descargar_pdf">
                <a target="_blank" href="pdfUsuario.php?id_usuario=<?php echo urlencode($id_usuario); ?>" class="boton2">Descargar información</a>
              </div>
              </div>
              <div class="navegacion_usuario">
                <button class="boton" onclick="history.back()"><< Regresar al listado de usuarios</button>
              </div>
            </div>
            <div class="ayuda">
