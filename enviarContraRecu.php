<?php
    ...
    if(isset($_POST["send"])){
        ...
        //if (isset($_POST["send"])) {
            ...
            $mail->Subject = 'BizLab - Recuperar Contrasenia';   // email subject headings
            $mail->Body    = '<span style="font-size: 15px; color: #444; font-family: `Montserrat`, sans-serif;">El código de recuperacion para su contraseña <b>BizLab</b> es: </span><br><br>
