...
<head>
  ...
  <link rel="stylesheet" href="estilos\transaccionExitosa.scss">
...
<body class="body">
  ...
  <form method="post" action="http://localhost/BizLab/registroReseFacNewRese.php" id="indexRegistroFacRese" name="indexRegistroFacRese">
