...
function obtener_Id_usuario() {
    if (isset($_SESSION['iniciado'])) {
        return $_SESSION['iniciado'];
    } else {
        return null;
    }
}

$querymembresias = "SELECT * FROM membresias";
...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .contenedor_texto_bizclub h3, 
            .contenedor_texto_bizclub h1, 
            .contenedor_texto_bizclub p {
                margin: 0;
                padding: 5px;
            }
    ...
    <main class="main">
                <div class="contenedor_todo">
                    <?php
                    if ($resultmembresias && $resultmembresias->num_rows > 0){
                        while ($membresia = $resultmembresias->fetch_assoc()){
                            echo '<a href="#">'; /* DANIEL AQUI PONGA PARA QUE AL TOCAR LAS TARJETAS LOS MANDEN A COMPRAR LA MEMBREISIA */
                            echo '<div class="contenedor_base">';
                            echo '<div class="contenedor_imagen">';
                            echo '<img src="images/Sala_reuniones.jpg">';
                            echo '</div>';
                            echo '<div class="contenedor_texto_bizclub">';
                            echo '<h3>' . $membresia['membre_nombre'] . '</h3>';
                            echo '<h1>' . $membresia['membre_mensualidad'] . '</h1>';
                            echo '<p>DESCRIPCION:</p>';
                            echo '<p>' . $membresia['membre_descrip'] . '</p>';
                            echo '</div>';
                            echo '</div>';
                            echo '</a>';
                        }
