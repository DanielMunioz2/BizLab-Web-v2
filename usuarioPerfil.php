<?php
    ...
    if(isset($_SESSION["iniciado"])){
        ...
        $nombre = $resultadoUser["user_nombre"]." ".$resultadoUser["user_apellido"];
        $cargo = $resultadoUser["user_cargo"];
        $rol = $resultadoUser["user_rol"];
        $imagenUser = $resultadoUser["user_imagen"];
        $telefono = $resultadoUser["user_telefono"];
        $placeholderTel = $telefono == "" ? "Sin Dato" : "";
        ...
        if($userTipo == "Miembro"){
                ...
                <div class="headerDiv1">
                    ...
                    <div class="divPerfilGene">   
                        <div id="divPerfil" class="divPerfil">
                            <div class="divImg">
                                <img src="imagesUser/'.$imagenUser.'" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="div1">
                        ...
                        <a id="ajustesCuentaBtn"><button class="buttonBloq2" disabled>
            ...
            if($userTipo == "Administrador"){
                $htmlHeader = '
                <header class="headerAdmi">
                    <div class="header_div1">
                        <div class="divPerfilContaint">
                            <div class="divImgCont">
                                <div>
                                    <img src="imagesUser/'.$imagenUser.'" alt="Imágen de Perfil">
                                </div>
                            </div>
                            <div class="divNombreCont">
                                <span class="nombrePerfil">'.$nombre.'</span>
                                <span class="carreraUPerfil">'.$cargo.'</span>
                                <div class="divTipo">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 312.57 425.95"><g id="Capa_2" data-name="Capa 2"><g id="Capa_1-2" data-name="Capa 1"><path d="M312.5,361.84a41.53,41.53,0,0,1-6.35,19.76,39.76,39.76,0,0,1-6.51,7.89,50.8,50.8,0,0,1-7.36,5.54c-2.73,1.72-5.46,3.44-8.29,5-3.08,1.69-6.18,3.36-9.37,4.86-4.13,1.95-8.33,3.73-12.58,5.38-5.46,2.11-11,3.92-16.67,5.5-6.64,1.86-13.36,3.38-20.14,4.64-4.1.76-8.21,1.45-12.34,2-2.8.36-5.6.76-8.4,1.08-2.36.28-4.74.47-7.1.69-1.83.17-3.65.37-5.48.51s-3.95.25-5.93.37l-9,.52-.75,0c-6.64,0-13.28.53-19.23.31-3.13,0-5.56,0-8,0-4.21,0-8.42-.25-12.64-.35-2.07-.05-4.16-.07-6.23-.28s-4.36-.16-6.53-.44c-1.81-.23-3.65-.25-5.48-.39-1.68-.13-3.36-.3-5-.47-1.24-.12-2.47-.24-3.7-.39-3.54-.42-7.09-.8-10.62-1.3q-7.51-1.06-15-2.56A225.53,225.53,0,0,1,61.44,414q-7.19-2.25-14.15-5A164.38,164.38,0,0,1,31,401.35a146.86,146.86,0,0,1-13.1-8A39.53,39.53,0,0,1,5.54,380.12,41.2,41.2,0,0,1,.75,367.05a26.61,26.61,0,0,1-.51-4.28,12,12,0,0,0-.14-1.33,14.79,14.79,0,0,1,0-3.12c.14-1.67.3-3.35.49-5,.32-2.76.62-5.52,1-8.27.64-4.62,1.51-9.19,2.5-13.75,1-4.75,2.27-9.45,3.65-14.11a164.4,164.4,0,0,1,6-16.67q1.52-3.63,3.2-7.2a161.83,161.83,0,0,1,9.27-17,150.11,150.11,0,0,1,9.06-12.9c2.29-2.93,4.73-5.74,7.15-8.56.23-.26.48-.5.72-.75,1.19-1.26,2.43-2.48,3.56-3.8a18.63,18.63,0,0,1,2.68-2.57,10.13,10.13,0,0,0,.77-.7,135.1,135.1,0,0,1,14.5-12.31A150.18,150.18,0,0
-9.09,11.13-17.38,17.27-25.66,2.81-3.78,3.37-6.86,1.21-11.26A217.44,217.44,0,0,1,48.08,234c-1-3.09-2.6-4.48-5.87-5-10.33-1.67-20.57-3.88-30.9-5.56-5.18-.85-8.18-3.79-9.11-8.58a134.89,134.89,0,0,1-.66-44.69c.67-4.72,3.74-7.14,8.1-8.43,9.11-2.72,18.51-4,27.83-5.6,6.34-1.09,9.78-4.08,11.9-10.23,3.08-8.94,7.1-17.58,11-26.2,1.38-3,1.11-5.11-.84-7.69C53.65,104.19,47.78,96.3,43,87.71c-5-8.9-4.87-11.91,2-19.59A308.71,308.71,0,0,1,71.77,42c3.58-3.15,6.94-3.33,10.87-1.15,6.41,3.56,12.86,7.3,18.14,12.28,9,8.48,17.45,11.14,28.58,3.26,5.79-4.1,13.44-5.61,20.32-8.09A6,6,0,0,0,154.07,43c1.72-10,3.51-20,5.77-29.87C161.94,4,165,1.84,174.3,1A191.44,191.44,0,0,1,210.13.74c6.33.59,9.54,3.88,11.41,9.4a101.64,101.64,0,0,1,4.65,23.94c.73,8.66,4.44,14.09,13.05,16.61a110.34,110.34,0,0,1,26.18,10.93c2.32,1.4,4,.59,5.87-.73,8-5.61,15.88-11.55,24.42-16.44,9.37-5.37,11.92-5.22,20,1.72a190.76,190.76,0,0,1,22.94,22.89C341.09,72,343.09,75.31,343.11,79.39ZM282.68,190.91c1.58-41.58-34.62-90.48-92-91.36-43.58-.67-92.74,39.68-91.11,94.73,1.34,45,39.75,89.34,91.66,89.4C242.74,283.74,282.62,243.28,282.68,190.91Z"/></g></g></svg>
                                        Ajustes de la Cuenta
                                    </button></a>
                                </div>
...
<!DOCTYPE html>
<html lang="en" id="usuarioPerfilHTML">
<head>
    ...
    <main class="main">
        <div class="baseGeneral">
            <div class="divImgGene">
                <div class="imgBase">
                    <div class="divImgBase">
                        <label for="subirImagenBtn" class="divImgCambio divImgCambio-B">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 383.56 383.57"><g id="Capa_2" data-name="Capa 2"><g id="Capa_1-2" data-name="Capa 1"><path d="M361,196c-.73-2.9-1.92-3.27-4.41-1.76-6.81,4.15-13.73,8.14-20.59,12.2q-26.88,15.92-53.75,31.84c-1,.61-2.61,1-2.56,2.41,0,1,1.44,1.21,2.34,1.59,4.6,1.94,9.17,3.92,13.81,5.74,2.32.91,2.67,2,1.42,4.2A127.32,127.32,0,0,1,266,289.12c-24.73,19.76-53.23,27.44-84.46,26.54-2.88-.08-3.22-1.05-2.67-3.67a90.36,90.36,0,0,0,.23-36.37c-8.36-42.46-47.2-77.78-97.54-72.68-32.85,3.33-57,20.87-72.46,50.15-4.82,9.13-7.29,19-9.11,29.11v22.45c.41,2,.86,3.89,1.22,5.84,7.58,41.36,45.43,73,87.54,73,33.67,0,67.35-.1,101,.07a187.1,187.1,0,0,0,40.08-3.83c38.57-8.25,71.36-26.81,98.55-55.34a187.37,187.37,0,0,0,32.28-46.09c1.07-2.16,2.17-2.61,4.35-1.64,4.67,2.08,9.41,4,14.15,5.9,1.09.44,2.3,1.62,3.41.63.88-.8.16-2.15-.1-3.19Q371.76,238,361,196ZM115,355.71a71,71,0,0,1-
75-32.37,10.47-35.37,28-2.76,16.11,5.27,33.6,25.42,40.12-1.19,1.22-2.81.83-4.19,1.15a55.63,55.63,0,0,0-32.61,21c-2,2.59-3.09,2.41-5,.15-9.75-11.44-15.47-24.43-16.64-39.57C224.18,61,247.93,31.91,278,24.78ZM37.4,128.26c16.81-39.41,43.71-69.37,82.17-88.53a159.71,159.71,0,0,1,64.7-16.53c16-.74,31.9-.15,48.12-.13a111.46,111.46,0,0,0-16.08,20.14c-1,1.56-2.49,1.44-4,1.44h-21.7c-33.49,0-63,11.18-89,32a144.27,144.27,0,0,0-44.38,60.58c-2.43,6.18-5.9,10.47-11.8,13.53-7.49,3.88-6.91,4.09-9.48-3.92C33.87,140.24,34.72,134.55,37.4,128.26Z"/></g></g></svg> 
                            <span>Cambiar Imagen</span>
                        </label>
                        <figure id="imgContenedor">
                            <img id="imgSelectedUser" src="imagesUser/<?php echo $imagenUser; ?>" alt="">
                        </figure>
                    </div>
                    <input type="file" id="subirImagenBtn" name="subirImagenBtn" accept="image/*">
                </div>
                <div class="divNombreCargo">
                    <span class="nombre"><?php echo $nombre; ?></span>
                    <span class="cargo"><?php echo $cargo; ?></span>
                </div>
                <div class="divDatos">
                    <div class="fechaUnionDiv">
                        <span>Fecha de unión</span>
                        <span><?php echo $resultadoUser["user_fechaU"]." | ".$resultadoUser["user_horaU"]; ?></span>
                    </div>
                    <div class="divDocumento">
                        <span>Documento</span>
                        <span><?php echo "CC ".$resultadoUser["user_documento"]; ?></span>
                    </div>
                    <div class="empresaDiv">
                        <span>Empresa</span>
                        <span><?php echo $resultadoUser["user_empresa"]; ?></span>
                    </div>
                    <div class="cargoDiv">
                        <span>Rol BizClub</span>
                ...
                <div class="divDataBase">
                    <div class="divDatosContacto">
                        ...
                        <div class="data">
                            <div>   
                                <span>Email</span>
                                <input disabled class="inputEmail" type="text" value="<?php echo $resultadoUser["user_correo"]; ?>">
                            </div>
                            <div>
                                <span>Teléfono</span>
                                <input disabled placeholder="<?php echo $placeholderTel; ?>" class="inputTelef" type="text" value="<?php echo $telefono; ?>">
                            </div>
                            <div>
                                <span>Celular</span>
                                <input disabled class="inputCelular" type="text" value="<?php echo $resultadoUser["user_celular"]; ?>">
                            </div>
                            <div class="direccionDiv">
                                <span>Dirección</span>
                                <input disabled class="inputDirecc" type="text" value="<?php echo $resultadoUser["user_direc"]; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="divOtrosDatos">
                        <span class="titulo">Otros Datos</span>
                        <div class="data">
                            <div>   
                                <span>Género</span>
                                <select disabled id="generoInput" class="select-B" name="generoInput">
                                    <option <?php echo $generoMas; ?>>Masculino</option>
                                    <option <?php echo $generoFem; ?>>Femenino</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="divBtnGene">
                        <div class="divBtnGuardaCancel divBtnGuardaCancel-C">
                            <button class="btnCancelar" disabled>Cancelar</button>
                            <button class="btnGuardar btnGuardar-C" disabled>Guardar Cambios</button>
                        </div>
                        <div class="divBtnEdit divBtnEdit-A">
                            <button class="btnActualizar">Actualizar Info</button>
                        </div>
                    </div>
                </div>
            </div>
