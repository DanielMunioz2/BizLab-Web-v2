        ...
        <div class="contenedor_todo">
            ...
            if ($resultProductos && $resultProductos->num_rows > 0) {
                while ($producto = $resultProductos->fetch_assoc()) {
                    ...
                    echo '<h3>' . $producto['produNombre'] . '</h3><br>';
                    echo '<h1>Por hora: ' . $producto['precioXhora'] . ' | Por día: ' . $producto['precioXDia'] . ' | Por semana: ' . $producto['precioXSemana'] . '</h1><br>';
                    echo '<p>DESCRIPCION:</p>';
                    echo '<p>' . $producto['produDescri'] . '</p>';
                    echo '</div>';
                    echo '</div>';
                    echo '</a>';
                }
